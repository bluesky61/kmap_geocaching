...
<tr>
	<td>아이디</td>
	<td><input type='text' id='user_id' name='user_id' tabindex='1' value="<?php echo $_COOKIE['username']; ?>"></td>
	<td rowspan='2'><input type='button' id='login' tabindex='3' value='로그인' style='height:50px'/></td>
</tr>
<tr>
	<td>비밀번호</td>
	<td><input type='password' id='user_pw' name='user_pw' tabindex='2' value="<?php echo $_COOKIE['password']; ?>"></td>
</tr>
</table>
</form>
<div id="message"></div>
